...
enum RPCServer {
    ...
    var priceID: Address {
        ...
        case .ellaism: return EthereumAddress(string: "0x0000000000000000000000000000000000000040")!
        }
    }

    var isDisabledByDefault: Bool {
        switch self {
        case .ellaism: return false
    ...
    var ensContract: EthereumAddress {
        ...
        case .ellaism:
            return EthereumAddress(string: "0x518232dd973C321107D28Cb11483b857b9A1E158")!
    ...
    var openseaPath: String {
        switch self {
        case .main, .classic, .poa, .callisto, .gochain, .ellaism: return Constants.dappsOpenSea
        }
    }
    ...
    var coin: Coin {
        ...
        case .ellaism: return Coin.ellaism
        }
    }
}
